...
export default async function AdminPage() {
  ...
  return (
    <>
      ...
      <Script src="/v1/js/carousel.js" strategy="afterInteractive" />
      <Script src="/v1/js/app.js" strategy="afterInteractive" />
      <Script src="/js/admin-shell.js" strategy="afterInteractive" />
    </>
  );
}
